...
static uint32_t g_dss_module_base[DSS_CHN_MAX_DEFINE][MODULE_CHN_MAX] = {
	...
	0,  // MODULE_ARSR2P
	0,  // MODULE_ARSR2P_LUT
	DSS_WCH0_POST_CLIP_OFFSET,  // MODULE_POST_CLIP
	DSS_WCH0_PCSC_OFFSET,  // MODULE_PCSC
...
#define HISI_DSS_DPP_MAX_SUPPORT_BIT (0x1fff) // 10 dpp module, 10bit, contrast to enmu dpp_module_idx
#define HISIFB_DSS_PLATFORM_TYPE  (FB_ACCEL_DSSV350 | FB_ACCEL_PLATFORM_TYPE_ASIC)
