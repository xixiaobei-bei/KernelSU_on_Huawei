...
#define DDR_F2L_CONFIG_ADDR_AP DDR_FP_IMAGE_END_AP
#define DDR_F2L_CONFIG_SIZE (0x1000)
#define DDR_F2L_END_AP (DDR_F2L_CONFIG_ADDR_AP + DDR_F2L_CONFIG_SIZE)
#define DDR_DTB_BASE_AP DDR_F2L_END_AP
#define DDR_DTB_SIZE (0x7F000)
...
#define DDR_AOD_BASE_AP HISI_RESERVED_SENSORHUB_AOD_PHYMEM_BASE
#define DDR_AOD_SIZE HISI_RESERVED_SENSORHUB_AOD_PHYMEM_SIZE
#define DDR_AOD_END_AP (HISI_RESERVED_SENSORHUB_AOD_PHYMEM_BASE + HISI_RESERVED_SENSORHUB_AOD_PHYMEM_SIZE)
#endif
