...
#define SOC_MEDIA1_CRG_CLKDIV15_ADDR(base) ((base) + (0x09CUL))
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int gt_aclk_disp_noc_subsys_sh : 1;
        unsigned int gt_aclk_dss_sh : 1;
        unsigned int gt_pclk_disp_noc_subsys_sh : 1;
        unsigned int gt_pclk_dss_sh : 1;
        unsigned int gt_clk_vivobus2ddrc_sh : 1;
...
#define SOC_MEDIA1_CRG_PEREN2_gt_aclk_disp_noc_subsys_sh_START (10)
#define SOC_MEDIA1_CRG_PEREN2_gt_aclk_disp_noc_subsys_sh_END (10)
#define SOC_MEDIA1_CRG_PEREN2_gt_aclk_dss_sh_START (11)
#define SOC_MEDIA1_CRG_PEREN2_gt_aclk_dss_sh_END (11)
#define SOC_MEDIA1_CRG_PEREN2_gt_pclk_disp_noc_subsys_sh_START (12)
#define SOC_MEDIA1_CRG_PEREN2_gt_pclk_disp_noc_subsys_sh_END (12)
#define SOC_MEDIA1_CRG_PEREN2_gt_pclk_dss_sh_START (13)
#define SOC_MEDIA1_CRG_PEREN2_gt_pclk_dss_sh_END (13)
#define SOC_MEDIA1_CRG_PEREN2_gt_clk_vivobus2ddrc_sh_START (14)
#define SOC_MEDIA1_CRG_PEREN2_gt_clk_vivobus2ddrc_sh_END (14)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_MEDIA1_CRG_PERDIS2_gt_aclk_disp_noc_subsys_sh_START (10)
#define SOC_MEDIA1_CRG_PERDIS2_gt_aclk_disp_noc_subsys_sh_END (10)
#define SOC_MEDIA1_CRG_PERDIS2_gt_aclk_dss_sh_START (11)
#define SOC_MEDIA1_CRG_PERDIS2_gt_aclk_dss_sh_END (11)
#define SOC_MEDIA1_CRG_PERDIS2_gt_pclk_disp_noc_subsys_sh_START (12)
#define SOC_MEDIA1_CRG_PERDIS2_gt_pclk_disp_noc_subsys_sh_END (12)
#define SOC_MEDIA1_CRG_PERDIS2_gt_pclk_dss_sh_START (13)
#define SOC_MEDIA1_CRG_PERDIS2_gt_pclk_dss_sh_END (13)
#define SOC_MEDIA1_CRG_PERDIS2_gt_clk_vivobus2ddrc_sh_START (14)
#define SOC_MEDIA1_CRG_PERDIS2_gt_clk_vivobus2ddrc_sh_END (14)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_MEDIA1_CRG_PERCLKEN2_gt_aclk_disp_noc_subsys_sh_START (10)
#define SOC_MEDIA1_CRG_PERCLKEN2_gt_aclk_disp_noc_subsys_sh_END (10)
#define SOC_MEDIA1_CRG_PERCLKEN2_gt_aclk_dss_sh_START (11)
#define SOC_MEDIA1_CRG_PERCLKEN2_gt_aclk_dss_sh_END (11)
#define SOC_MEDIA1_CRG_PERCLKEN2_gt_pclk_disp_noc_subsys_sh_START (12)
#define SOC_MEDIA1_CRG_PERCLKEN2_gt_pclk_disp_noc_subsys_sh_END (12)
#define SOC_MEDIA1_CRG_PERCLKEN2_gt_pclk_dss_sh_START (13)
#define SOC_MEDIA1_CRG_PERCLKEN2_gt_pclk_dss_sh_END (13)
#define SOC_MEDIA1_CRG_PERCLKEN2_gt_clk_vivobus2ddrc_sh_START (14)
#define SOC_MEDIA1_CRG_PERCLKEN2_gt_clk_vivobus2ddrc_sh_END (14)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int sc_gt_aclk_mmbuf_sh : 1;
...
#endif
#define SOC_MEDIA1_CRG_CLKDIV15_sc_gt_clk_edc0_sh_START (0)
#define SOC_MEDIA1_CRG_CLKDIV15_sc_gt_clk_edc0_sh_END (0)
#define SOC_MEDIA1_CRG_CLKDIV15_sc_gt_aclk_mmbuf_sh_START (1)
#define SOC_MEDIA1_CRG_CLKDIV15_sc_gt_aclk_mmbuf_sh_END (1)
#define SOC_MEDIA1_CRG_CLKDIV15_sc_gt_clk_vivobus_sh_START (2)
#define SOC_MEDIA1_CRG_CLKDIV15_sc_gt_clk_vivobus_sh_END (2)
