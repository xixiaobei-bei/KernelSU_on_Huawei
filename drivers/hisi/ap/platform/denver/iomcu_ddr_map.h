...
#define DDR_AOD_BASE_AP HISI_RESERVED_SENSORHUB_SHARE_MEM_AOD_BASE
#define DDR_AOD_SIZE HISI_RESERVED_SENSORHUB_SHARE_MEM_AOD_SIZE
#define DDR_AOD_END_AP (DDR_AOD_BASE_AP + DDR_AOD_SIZE)
#define DDR_DUMP_BASE_AP HISI_RESERVED_SENSORHUB_SHARE_MEM_DUMP_BASE
#define DDR_DUMP_SIZE HISI_RESERVED_SENSORHUB_SHARE_MEM_DUMP_SIZE
