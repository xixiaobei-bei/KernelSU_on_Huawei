...
#define LPMCU_MODEM_SEC_SIZE (0x2400)
    ...
    #define MODEM_RESERVED_BASE (AON_STORAGE_SOCP_BASE + AON_STORAGE_SOCP_SIZE)
    #define MODEM_RESERVED_SIZE (0x10)
    #define MODEM_PARA_BASE (MODEM_RESERVED_BASE + MODEM_RESERVED_SIZE)
...
#define LPMCU_DDR_DATA_SEC_SIZE (0xA800)
    ...
    #define DDR_QOS_BASE (DDR_POLICY_LT_BASE + DDR_POLICY_LT_SIZE)
...
#define AON_SYS_SIZE (0x10000 - AON_SYS_RESERVED_SIZE)
...
#define SYS_CODE_SEC_SIZE (0x1C800-SYS_CODE_SEC_RESERVED_SIZE)
...
#define SYS_BSS_SEC_SIZE (0x5800-SYS_BSS_SEC_RESERVED_SIZE)
#define SYS_DATA_SEC_BASE (SYS_BSS_SEC_BASE + SYS_BSS_SEC_SIZE + SYS_BSS_SEC_RESERVED_SIZE)
#define SYS_DATA_SEC_RESERVED_SIZE (0x400)
#define SYS_DATA_SEC_SIZE (0x1D00-SYS_DATA_SEC_RESERVED_SIZE)
