...
CFG_NR_MAX_NR_FSD_OTHER_PARA_NUM:=32
CFG_NR_MAX_NR_FSU_OTHER_PARA_NUM:=32
...
CFG_NR_MAX_NR_FSPC_DL_NUM:=64
CFG_NR_MAX_NR_FSPC_UL_NUM:=64
CFG_NR_MAX_SIMPLE_FSC_NUM_PER_SUPER_FSC:=16
CFG_NR_MAX_FSC_NUM:=128
CFG_NR_MAX_PER_BC_NR_BAND_NUM := 1
