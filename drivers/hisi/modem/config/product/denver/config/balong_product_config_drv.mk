...
CFG_CCPU_CORE_NUM := 1
CFG_CONFIG_CCPU_FIQ_SMP := NO
CFG_CCPU_LLRAM_BASE_ADDR := 0xE0800000
CFG_CCPU_LLRAM_BASE_SIZE := 0x18000
CFG_CCPU_SRAM_SIZE  := 0x2C00
CFG_SOCP_LLRAM_ADDR            := (CCPU_LLRAM_BASE_ADDR + CCPU_SRAM_SIZE)
CFG_SOCP_LLRAM_SIZE            := 0x8000
CFG_LL2_LLRAM_BASE_ADDR        := (SOCP_LLRAM_ADDR + SOCP_LLRAM_SIZE)
CFG_LL2_LLRAM_SIZE             := 0xC800
CFG_CONFIG_CCPU_HAS_LLRAM := YES
CFG_CCPU_LLRAM_ADDR := (LL2_LLRAM_BASE_ADDR + LL2_LLRAM_SIZE)
CFG_CCPU_LLRAM_SIZE := (CCPU_LLRAM_BASE_SIZE - CCPU_SRAM_SIZE - SOCP_LLRAM_SIZE - LL2_LLRAM_SIZE)
...
CFG_DIAG_MODEM_SINGLE_CORE := YES
...
CFG_CONFIG_ARM_BASLR_RELOC_SIZE := 0x1500000
...
CFG_DDR_MCORE_SIZE        := 0x6F00000
CFG_DDR_MCORE_NR_SIZE     := 0x2800000
CFG_DDR_MCORE_DTS_SIZE    := 0x180000
CFG_DDR_GU_SIZE           := 0x40000
CFG_DDR_LPHY_SDR_SIZE     := 0x880000
CFG_DDR_LCS_SIZE          := 0x280000
CFG_DDR_SDR_NR_SIZE       := 0x1400000
CFG_DDR_CBBE_IMAGE_SIZE   := 0x0
CFG_DDR_HARQ_UP_SIZE      := 0x60000
CFG_DDR_HARQ_NRUL_SIZE    := 0x300000
...
CFG_DDR_MCORE_UNCACHE_SIZE:= 0x1F00000
CFG_DDR_MCORE_NR_UNCACHE_SIZE     := 0x00700000
...
CFG_DDR_LRCCPU_DTBO_SIZE := 0x2000
CFG_DDR_LPMCU_DTBO_SIZE := 0x2000
CFG_DDR_NRCCPU_DTBO_SIZE := 0x2000
CFG_DDR_L2CPU_DTBO_SIZE := 0x2000
CFG_DDR_MDTS_COMMON_SIZE := $(CFG_DDR_LRCCPU_DTS_SIZE) + $(CFG_DDR_LPMCU_DTS_SIZE) + $(CFG_DDR_NRCCPU_DTS_SIZE) + $(CFG_DDR_L2CPU_DTS_SIZE)
CFG_DDR_MDTS_OVERLAY_SIZE := $(CFG_DDR_IMAGE_DTBO_SIZE) + $(CFG_DDR_LRCCPU_DTBO_SIZE) + $(CFG_DDR_LPMCU_DTBO_SIZE) + $(CFG_DDR_NRCCPU_DTBO_SIZE) + $(CFG_DDR_L2CPU_DTBO_SIZE)
CFG_DDR_IMAGE_DTBO_ADDR := $(CFG_DDR_L2CPU_DTS_ADDR) + $(CFG_DDR_L2CPU_DTS_SIZE)
CFG_DDR_LRCCPU_DTBO_ADDR := $(CFG_DDR_IMAGE_DTBO_ADDR) + $(CFG_DDR_IMAGE_DTBO_SIZE)
...
CFG_MODEM_SHARED_DDR_BASE := (0x18000000)
...
CFG_MODEM_SOCP_DDR_BASE  := (0xAE180000)
