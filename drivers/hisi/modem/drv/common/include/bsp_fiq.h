...
#define SHM_FIQ_NR_BASE_ADDR                              (SHM_OFFSET_NRCCORE_FIQ + (unsigned long)SHM_BASE_ADDR)
#define SHM_FIQ_NR_BARRIER                	              (SHM_FIQ_NR_BASE_ADDR)
#define SHM_FIQ_NR_STATUS_ADDR                            (SHM_FIQ_NR_BARRIER + (unsigned long)0x4)
#define SHM_FIQ_NR_CLEAR_ADDR                             (SHM_FIQ_NR_STATUS_ADDR + (unsigned long)(0x4 *NRCCPU_CORE_NUM))
#define SHM_FIQ_NR_TIMER_ADDR                             (SHM_FIQ_NR_CLEAR_ADDR + (unsigned long)(0x4 *NRCCPU_CORE_NUM))
#define SHM_FIQ_NR_TOTAL_SEND_CNT                         (SHM_FIQ_NR_TIMER_ADDR + (unsigned long)(0x4 *NRCCPU_CORE_NUM))
#define SHM_FIQ_NR_TOTAL_RECIVE_CNT                       (SHM_FIQ_NR_TOTAL_SEND_CNT + (unsigned long)(0x4 *NRCCPU_CORE_NUM))
#define SHM_FIQ_NR_INFO_ADDR                              (SHM_FIQ_NR_TOTAL_RECIVE_CNT + (unsigned long)(0x4 *NRCCPU_CORE_NUM))
#else
#define SHM_FIQ_NR_BASE_ADDR                              (SHM_OFFSET_NRCCORE_FIQ + (unsigned long)SHM_BASE_ADDR)
#define SHM_FIQ_NR_BARRIER                	              (SHM_FIQ_NR_BASE_ADDR)
#define SHM_FIQ_NR_STATUS_ADDR                            (SHM_FIQ_NR_BARRIER + (unsigned long)0x4)
#define SHM_FIQ_NR_CLEAR_ADDR                             (SHM_FIQ_NR_STATUS_ADDR + (unsigned long)0x4)
#define SHM_FIQ_NR_TIMER_ADDR                             (SHM_FIQ_NR_CLEAR_ADDR + (unsigned long)0x4)
#define SHM_FIQ_NR_TOTAL_SEND_CNT                         (SHM_FIQ_NR_TIMER_ADDR + (unsigned long)0x4)
#define SHM_FIQ_NR_TOTAL_RECIVE_CNT                       (SHM_FIQ_NR_TOTAL_SEND_CNT + (unsigned long)0x4)
#define SHM_FIQ_NR_INFO_ADDR                              (SHM_FIQ_NR_TOTAL_RECIVE_CNT + (unsigned long)0x4)
#endif 
 ...
 **/ 
 ...
 UINT32 fiq_handler(struct ExcInfo *pstExcInfo);
/**
