								  ...
								  isp_stripe_info_t *stripe_info, isp_stripe_info_t *stripe_info_DS4, unsigned int stripe_index)
{
	...
	pr_info("crop0 = %d,%d,crop1 = %d,%d,crop2 = %d,%d", cfg_tab->crop_vpwr.crop_vpwr_0.vpwr_ihleft,
...
static void mcf_update_cmdlst_cfg_tab(cfg_tab_cmdlst_t *cmdlst_cfg, unsigned int channel_id,
...
static int mcf_set_irq_mode(msg_req_mcf_request_t *mcf_request, schedule_cmdlst_link_t *cmd_link_entry,
