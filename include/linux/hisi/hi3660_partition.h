...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_RESERVED7,        1032 *1024, 32*1024,       EMMC_USER_PART},/* reserved7      32M    p54*/
  ...
  {PART_SYSTEM_A,         2264*1024, 3352*1024,     EMMC_USER_PART},/* system          3352M  p59*/
  {PART_PATCH_A,          5616*1024, 200*1024,     EMMC_USER_PART},/* patch             200M  p60*/
  {PART_RESERVED5,        5816*1024, 128*1024,       EMMC_USER_PART},/* reserved5      128M   p61*/
  {PART_USERDATA,         5944*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G     p62*/
  #else
  {PART_SYSTEM_A,         2264*1024, 4488*1024,     EMMC_USER_PART},/* system          4488M  p59*/
  {PART_PATCH_A,          6752*1024,  200*1024,     EMMC_USER_PART},/* patch            200M  p60*/
  {PART_RESERVED5,        6952*1024, 128*1024,       EMMC_USER_PART},/* reserved5      128M   p61*/
  {PART_USERDATA,         7080*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G     p62*/
  #endif
...
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_RESERVED7,          1024*1024,  32*1024,      UFS_PART_3},/* reserved7           32M    p50*/
  ...
  #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         2256*1024, 3352*1024,     UFS_PART_3},/* system          3352M  p55*/
  {PART_PATCH_A,         5608*1024, 200*1024,     UFS_PART_3},/* patch          200M  p56*/
  {PART_RESERVED5,        5808*1024, 128*1024,      UFS_PART_3},/* reserved5       64M    p57*/
  {PART_USERDATA,         5936*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p58*/
  #else
  {PART_SYSTEM_A,         2256*1024, 4488*1024,     UFS_PART_3},/* system          4488M  p55*/
  {PART_PATCH_A,         6744*1024, 200*1024,     UFS_PART_3},/* patch          200M  p56*/
  {PART_RESERVED5,        6944*1024, 128*1024,      UFS_PART_3},/* reserved5       64M    p57*/
  {PART_USERDATA,         7072*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p58*/
  #endif
  {"0", 0, 0, 0},
};
#endif
