...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_SYSTEM_A,           2256*1024, 2888*1024,          EMMC_USER_PART},/* system         2888M   p66*/
  {PART_PATCH_A,            5144*1024, 200*1024,           EMMC_USER_PART},/* patch           200M   p67*/
  {PART_USERDATA,           5344*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata        4G     p68*/
  #elif defined CONFIG_MARKET_OVERSEA
  {PART_VERSION_A,          800*1024,  32*1024,            EMMC_USER_PART},/* version         32M    p60*/
  {PART_VENDOR_A,           832*1024,  760*1024,           EMMC_USER_PART},/* vendor          760M   p61*/
  {PART_PRODUCT_A,          1592*1024, 192*1024,           EMMC_USER_PART},/* product         192M   p62*/
  ...
  {PART_ODM_A,              1976*1024, 176*1024,           EMMC_USER_PART},/* odm             176M   p64*/
  {PART_CACHE,              2152*1024, 104*1024,           EMMC_USER_PART},/* cache           104M   p65*/
  {PART_SYSTEM_A,           2256*1024, 3336*1024,          EMMC_USER_PART},/* system         3336M   p66*/
  {PART_PATCH_A,            5592*1024, 200*1024,           EMMC_USER_PART},/* patch           200M   p67*/
  {PART_USERDATA,           5792*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata          4G   p68*/
  #elif defined CONFIG_MARKET_FULL_OVERSEA
  {PART_VERSION_A,          800*1024,  32*1024,            EMMC_USER_PART},/* version         32M    p60*/
  {PART_VENDOR_A,           832*1024,  760*1024,           EMMC_USER_PART},/* vendor          760M   p61*/
  {PART_PRODUCT_A,          1592*1024, 192*1024,           EMMC_USER_PART},/* product         192M   p62*/
  ...
  {PART_ODM_A,              1976*1024, 176*1024,           EMMC_USER_PART},/* odm             176M   p64*/
  {PART_CACHE,              2152*1024, 104*1024,           EMMC_USER_PART},/* cache           104M   p65*/
  {PART_SYSTEM_A,           2256*1024, 5432*1024,          EMMC_USER_PART},/* system         5432M   p66*/
  {PART_PATCH_A,            7688*1024, 200*1024,           EMMC_USER_PART},/* patch           200M   p67*/
  {PART_USERDATA,           7888*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata          4G   p68*/
  #elif defined CONFIG_MARKET_FULL_INTERNAL
  {PART_VERSION_A,          800*1024,  32*1024,            EMMC_USER_PART},/* version         32M    p60*/
  {PART_VENDOR_A,           832*1024,  760*1024,           EMMC_USER_PART},/* vendor          760M   p61*/
  {PART_PRODUCT_A,          1592*1024, 192*1024,           EMMC_USER_PART},/* product         192M   p62*/
  ...
  {PART_ODM_A,              1976*1024, 176*1024,           EMMC_USER_PART},/* odm             176M   p64*/
  {PART_CACHE,              2152*1024, 104*1024,           EMMC_USER_PART},/* cache           104M   p65*/
  {PART_SYSTEM_A,           2256*1024, 4552*1024,          EMMC_USER_PART},/* system         4552M   p66*/
  {PART_PATCH_A,            6808*1024, 200*1024,           EMMC_USER_PART},/* patch           200M   p67*/
  {PART_USERDATA,           7008*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata          4G   p68*/
