...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_VENDOR_A,                  1096*1024,        1232*1024,        EMMC_USER_PART},/* vendor           760M    p62*/
  {PART_ODM_A,                     2328*1024,         192*1024,        EMMC_USER_PART},/* odm              192M    p63*/
  {PART_CUST_A,                    2520*1024,         192*1024,        EMMC_USER_PART},/* cust             192M    p64*/
  {PART_SYSTEM_A,                  2712*1024,        5680*1024,        EMMC_USER_PART},/* system          5680M    p65*/
  ...
  {PART_VENDOR_A,                  1096*1024,        1064*1024,        EMMC_USER_PART},/* vendor          1064M    p62*/
  ...
  {PART_VENDOR_A,                  1096*1024,         864*1024,        EMMC_USER_PART},/* vendor           864M    p62*/
  {PART_ODM_A,                     1960*1024,         136*1024,        EMMC_USER_PART},/* odm              136M    p63*/
  {PART_CUST_A,                    2096*1024,         136*1024,        EMMC_USER_PART},/* cust             136M    p64*/
#ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,                  2232*1024,        3184*1024,        EMMC_USER_PART},/* system          3184M    p65*/
...
#else
  {PART_SYSTEM_A,                  2232*1024,        3928*1024,        EMMC_USER_PART},/* system          3928M    p65*/
  ...
  {PART_CUST_A,                    2520*1024,         192*1024,        EMMC_USER_PART},/* cust             192M    p64*/
#ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,                  2712*1024,        4616*1024,        EMMC_USER_PART},/* system          4616M    p65*/
  {PART_PRODUCT_A,                 7328*1024,        1472*1024,        EMMC_USER_PART},/* product         1472M    p66*/
  {PART_VERSION_A,                 8800*1024,         576*1024,        EMMC_USER_PART},/* version          576M    p67*/
  {PART_PRELOAD_A,                 9376*1024,        1144*1024,        EMMC_USER_PART},/* preload_a       1144M    p68*/
  {PART_USERDATA,                 10520*1024,  (4UL)*1024*1024,        EMMC_USER_PART},/* userdata           4G    p69*/
...
static const struct partition partition_table_ufs[] =
{
...
#ifdef CONFIG_FACTORY_MODE
  {PART_VENDOR_A,                      1088*1024,        1232*1024,        UFS_PART_3},/* vendor               1232M    p58*/
  {PART_ODM_A,                         2320*1024,         192*1024,        UFS_PART_3},/* odm                   192M    p59*/
  {PART_CUST_A,                        2512*1024,         192*1024,        UFS_PART_3},/* cust                  192M    p60*/
  {PART_SYSTEM_A,                      2704*1024,        5680*1024,        UFS_PART_3},/* system               5680M    p61*/
...
#ifdef CONFIG_USE_EROFS
#ifdef CONFIG_UPDATE_PRODUCT_EROFS
  {PART_VENDOR_A,                        1088*1024,        1064*1024,        UFS_PART_3},/* vendor               1064M    p58*/
  ...
  {PART_PRELOAD_A,                       9368*1024,        1144*1024,        UFS_PART_3},/* preload              1144M    p64*/
  ...
  {PART_PRODUCT_A,                       8384*1024,        1328*1024,        UFS_PART_3},/* product              1328M    p62*/
  {PART_VERSION_A,                       9712*1024,         576*1024,        UFS_PART_3},/* version               576M    p63*/
  {PART_PRELOAD_A,                      10288*1024,        1144*1024,        UFS_PART_3},/* preload              1144M    p64*/
  {PART_USERDATA,                       11432*1024,  (4UL)*1024*1024,        UFS_PART_3},/* userdata                4G    p65*/
#endif
#else
  {PART_VENDOR_A,                        1088*1024,         864*1024,        UFS_PART_3},/* vendor                864M    p58*/
  {PART_ODM_A,                           1952*1024,         136*1024,        UFS_PART_3},/* odm                   136M    p59*/
  {PART_CUST_A,                          2088*1024,         136*1024,        UFS_PART_3},/* cust                  136M    p60*/
#ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,                      2224*1024,        3184*1024,        UFS_PART_3},/* system               3184M    p61*/
...
#else
  {PART_SYSTEM_A,                      2224*1024,        3928*1024,        UFS_PART_3},/* system               3928M    p61*/
  ...
  {PART_CUST_A,                        2512*1024,         192*1024,        UFS_PART_3},/* cust                  192M    p60*/
#ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,                      2704*1024,        4616*1024,        UFS_PART_3},/* system               4616M    p61*/
  {PART_PRODUCT_A,                     7320*1024,        1472*1024,        UFS_PART_3},/* product              1472M    p62*/
  {PART_VERSION_A,                     8792*1024,         576*1024,        UFS_PART_3},/* version               576M    p63*/
