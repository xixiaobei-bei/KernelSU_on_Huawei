...
static const struct partition partition_table_emmc[] =
{
  ...
  #else
  {PART_SYSTEM_A,        2552*1024,  5648*1024,       EMMC_USER_PART},/* system        5648M  p61*/
  {PART_PATCH_A,         8200*1024,  200*1024,        EMMC_USER_PART},/* patch         200M   p62*/
  {PART_PRODUCT_A,       8400*1024,  1328*1024,       EMMC_USER_PART},/* product       1328M  p63*/
  {PART_VERSION_A,       9728*1024,  576*1024,        EMMC_USER_PART},/* version       576M   p64*/
  {PART_PRELOAD_A,       10304*1024, 1144*1024,       EMMC_USER_PART},/* preload       1144M  p65*/
  {PART_USERDATA,        11448*1024, (4UL)*1024*1024, EMMC_USER_PART},/* userdata      4G     p66*/
  #endif
 #else
  {PART_VERSION_A,        808*1024,  32*1024,       EMMC_USER_PART},/* version         32M    p57*/
  {PART_VENDOR_A,         840*1024,  952*1024,      EMMC_USER_PART},/* vendor          952M   p58*/
  ...
  {PART_PRODUCT_A,        2264*1024, 592*1024,      EMMC_USER_PART},/* product         592M   p63*/
  #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         2856*1024, 3960*1024,       EMMC_USER_PART},/* system        3960M  p64*/
  {PART_PATCH_A,          6816*1024,  200*1024,       EMMC_USER_PART},/* patch         200M   p65*/
  {PART_USERDATA,         7016*1024, (4UL)*1024*1024, EMMC_USER_PART},/* userdata      4G     p66*/
  #else
  {PART_SYSTEM_A,         2856*1024, 4840*1024,       EMMC_USER_PART},/* system        4840M  p64*/
  {PART_PATCH_A,          7696*1024,  200*1024,       EMMC_USER_PART},/* patch         200M   p65*/
  {PART_USERDATA,         7896*1024, (4UL)*1024*1024, EMMC_USER_PART},/* userdata      4G     p66*/
  #endif
 #endif
#endif
...
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_USERDATA,       10520*1024, (4UL)*1024*1024,  UFS_PART_3},/* userdata      4G     p62*/
   #else
  {PART_SYSTEM_A,        2544*1024,  5648*1024,       UFS_PART_3},/* system        5648M  p57*/
  {PART_PATCH_A,         8192*1024,  200*1024,        UFS_PART_3},/* patch         200M   p58*/
  {PART_PRODUCT_A,       8392*1024,  1328*1024,       UFS_PART_3},/* product       1328M  p59*/
  {PART_VERSION_A,       9720*1024,  576*1024,        UFS_PART_3},/* version       576M   p60*/
  {PART_PRELOAD_A,       10296*1024, 1144*1024,       UFS_PART_3},/* preload       1144M  p61*/
  {PART_USERDATA,        11440*1024, (4UL)*1024*1024, UFS_PART_3},/* userdata      4G     p62*/
   #endif
 #else
  {PART_VERSION_A,        800*1024,   32*1024,      UFS_PART_3},/* version         32M    p53*/
  {PART_VENDOR_A,         832*1024,   952*1024,     UFS_PART_3},/* vendor          952M   p54*/
  ...
  {PART_PRODUCT_A,        3428*1024, 592*1024,      UFS_PART_3},/* product         592M   p59*/
   #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         4020*1024, 3960*1024,       UFS_PART_3},/* system        3960M  p60*/
  {PART_PATCH_A,          7980*1024,  200*1024,       UFS_PART_3},/* patch         200M   p61*/
  {PART_USERDATA,         8180*1024, (4UL)*1024*1024, UFS_PART_3},/* userdata      4G     p62*/
   #else
  {PART_SYSTEM_A,         4020*1024, 4840*1024,       UFS_PART_3},/* system        4840M  p60*/
  {PART_PATCH_A,          8860*1024,  200*1024,       UFS_PART_3},/* patch         200M   p61*/
  {PART_USERDATA,         9060*1024, (4UL)*1024*1024, UFS_PART_3},/* userdata      4G     p62*/
   #endif
  #else
  {PART_CACHE,            2128*1024, 128*1024,        UFS_PART_3},/* cache         128M   p58*/
  {PART_PRODUCT_A,        2256*1024, 592*1024,        UFS_PART_3},/* product       592M   p59*/
   #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         2848*1024, 3960*1024,       UFS_PART_3},/* system        3960M  p60*/
  {PART_PATCH_A,          6808*1024,  200*1024,       UFS_PART_3},/* patch         200M   p61*/
  {PART_USERDATA,         7008*1024, (4UL)*1024*1024, UFS_PART_3},/* userdata      4G     p62*/
   #else
  {PART_SYSTEM_A,         2848*1024, 4840*1024,       UFS_PART_3},/* system        4840M  p60*/
  {PART_PATCH_A,          7688*1024,  200*1024,       UFS_PART_3},/* patch         200M   p61*/
  {PART_USERDATA,         7888*1024, (4UL)*1024*1024, UFS_PART_3},/* userdata      4G     p62*/
   #endif
  #endif
 #endif
#endif
